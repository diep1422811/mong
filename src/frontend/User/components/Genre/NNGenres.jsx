...
function NNGenres() {
  ...
  const booksPerPage = 8; // Số sách mỗi trang (CẬP NHẬT)

  // Chuyển đổi tag từ URL thành không dấu và thay gạch nối thành khoảng trắng
  const formattedTag = removeAccents(tag.replace(/-/g, " ")).toLowerCase();
    ...
    <div className="search-results">
      <div className="tag-page">
        <div className="breadcrumb">
          <Link to="/vanhocnn" className="breadcrumb-link">
          <span className="breadcrumb-current">VĂN HỌC NƯỚC NGOÀI</span>
          </Link>
